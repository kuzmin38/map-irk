...
def _build_prompt() -> str:
    ...
    'Голосовые ты расшифровываешь и в чате, и в личке. «Сделай объявление '
    'жильцам» — код переложит сказанное деловым языком и по кнопке отправит в '
    'чат дома; сама туда не пишешь.\n'
