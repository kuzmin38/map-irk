...
ZADANIE = (
    ...
    '— если несколько сообщений подряд — это одно и то же происшествие в '
    'развитии (тревога → догадки жильцов → причина нашлась), запиши только '
    'итог одной строкой: что оказалось на самом деле. Не разговор целиком;\n'
    '— версии и обвинения без подтверждения («наверное, соседи сверху», '
    '«кто-то виноват», «похоже на») в факт не превращай. Это шум, даже если '
    'сообщений с этим много. Ждёт своего часа только то, что подтвердилось '
    'прямо — цифрой, найденной причиной, законченной работой;\n'
