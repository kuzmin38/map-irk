...
ZADANIE = (
    ...
    '5. Куда обращаться: «По авариям и заявкам — диспетчерская: {telefon}.» '
    'Телефон бери отсюда дословно и не меняй ни цифры.\n'
...
BEZ_TELEFONA = (ZADANIE
                .replace('5. Куда обращаться: «По авариям и заявкам — '
                         'диспетчерская: {telefon}.» Телефон бери отсюда '
                         'дословно и не меняй ни цифры.\n', '')
